    ...
    const renderSettings = () => {
        ...
        if (activeTab === 'sheets') {
             return (<div className="space-y-4">
                ...
                <div className="flex items-center gap-2 mt-1"><span className="text-xs">横位置:</span><input type="range" min="-100" max="100" value={layoutSettings.mark.hOffset} onChange={e => handleSettingChange('mark', 'hOffset', parseFloat(e.target.value))} className="w-full" /><span className="text-xs w-10 text-right">{layoutSettings.mark.hOffset}%</span></div><div className="flex items-center gap-2 mt-1"><span className="text-xs">縦位置:</span><input type="range" min="-100" max="100" value={layoutSettings.mark.vOffset} onChange={e => handleSettingChange('mark', 'vOffset', parseFloat(e.target.value))} className="w-full" /><span className="text-xs w-10 text-right">{layoutSettings.mark.vOffset}%</span></div></div>
